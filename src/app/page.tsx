      ...
      <ReactLenis root>
        ...
        <div id="services" data-section="services">
          <FeatureCardTwentyNine
            ...
            title="Our Services"
            description="Professional nail and lash services designed for your unique style."
            useInvertedBackground={false}
          />
        </div>
        ...
        <div id="pricing" data-section="pricing">
          <PricingCardEight
            animationType="slide-up"
            textboxLayout="split"
            description="Choose from our tiered packages designed for every beauty need."
            plans={[
